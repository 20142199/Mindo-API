import { BookOpen, CheckCircle2, CircleUserRound, Clock3, ExternalLink, Eye, Heart, Newspaper, Pencil, PlaySquare, Plus, RefreshCw, Rss, Settings2, Tags, X } from 'lucide-react';
...
type ArticleEditorValue = SaveNewsArticle & { id?: string; source?: NewsArticle['source']; source_author?: string; source_content?: string; source_published_at?: string; source_fetched_at?: string };
